...
def bonus_game_cat_pong():
    ...
    try:
        while running:
            ...
            if (keys[pygame.K_w] or keys[pygame.K_UP] or keys[pygame.K_KP8]) and player_cat_rect.top > 0:
                player_cat_rect.y -= PLAYER_SPEED
            if (keys[pygame.K_s] or keys[pygame.K_DOWN] or keys[pygame.K_KP2]) and player_cat_rect.bottom < HEIGHT:
                player_cat_rect.y += PLAYER_SPEED
