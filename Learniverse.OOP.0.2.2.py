...
class OptionsMenuState(GameState):
    ...
    def __init__(self, window_manager: WindowManager, text_renderer: TextRenderer, 
        ...
        self.font_row_y = self.window_manager.config.SCREEN_HEIGHT * 0.35  # Position for font selection
        self.theme_row_y = self.window_manager.config.SCREEN_HEIGHT * 0.5  # Position for theme selection
    ...
    def apply_theme_change(self):
        ...
        self.switch_to_options()  # Refresh the options menu to reflect theme change
