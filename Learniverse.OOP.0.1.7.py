...
class OptionsMenuState(GameState):
    ...
    def __init__(self, window_manager: WindowManager, text_renderer: TextRenderer, font_manager: FontManager, switch_to_main_menu: callable, switch_to_credits: callable):
        ...
        self.left_button = Button(
            x=0, y=self.resolution_row_y, text="<", text_renderer=text_renderer, action=self.window_manager.decrease_resolution
        )
        self.right_button = Button(
            x=0, y=self.resolution_row_y, text=">", text_renderer=text_renderer, action=self.window_manager.increase_resolution
        )
...
class StateManager:
    ...
    def switch_state(self, new_state_name: str) -> None:
        ...
        if new_state_name == "MAIN_MENU":
            ...
            self.current_state = OptionsMenuState(self.window_manager, self.text_renderer, self.font_manager, self.switch_to_main_menu, self.switch_to_credits)
