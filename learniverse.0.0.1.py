...
def center_window(width, height):
    ...
    try:
        ...
        print(f"Window centered at position: {window_x}, {window_y}")
...
# This block handles setting the game window's icon.
# If the icon file is not found or Pygame fails to load it, an error is logged,
# but the game continues without a custom icon.
try:
...
WINDOWED_RESOLUTIONS = [
    (600, 600), (700, 700), (800, 800), (900, 900), (1080, 1080)
]
...
def load_options():
    ...
    try:
        ...
        current_resolution_index = options.get("current_resolution_index", AVAILABLE_RESOLUTIONS.index((700, 700)))
