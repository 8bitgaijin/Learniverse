...
class MainMenuState(GameState):
    ...
    def __init__(self, config: Config, text_renderer: TextRenderer, 
        ...
        self.options_button = Button(
            ...
            text="Go to Options",  # Text for the button
            text_renderer=text_renderer,  # TextRenderer object
...
class OptionsMenuState(GameState):
    ...
    def __init__(self, window_manager: WindowManager, text_renderer: TextRenderer, font_manager: FontManager, switch_to_main_menu: callable, switch_to_credits: callable, switch_to_options: callable):
        ...
        # Dynamically calculate resolution row based on the screen height
        ...
        self.left_button = Button(
            x=0, y=self.resolution_row_y, text="<", text_renderer=text_renderer, action=lambda: [self.window_manager.decrease_resolution(), self.switch_to_options()]
        )
        self.right_button = Button(
            x=0, y=self.resolution_row_y, text=">", text_renderer=text_renderer, action=lambda: [self.window_manager.increase_resolution(), self.switch_to_options()]
        )
